...
from pcdet.models.mamba_models.scene_memory_model import SceneMemoryModel
...
def main():
    ...
    model = SceneMemoryModel(cfg.MODEL.SCENE_MEMORY_MODEL_CFG, len(cfg.CLASS_NAMES), train_set)
    if args.sync_bn:
    ...
    if hasattr(model, "total_iters"):
        model.total_iters = len(train_loader) * args.epochs
        print("Set model.total_iters to", model.total_iters)
    model.train()
